...
func initDb() *gorp.DbMap {
    ...
    //db, err := sql.Open("mysql", db_user + ":" + db_password + "@tcp(" + db_host + ":" + db_port + ")/" + db_database)
    db, err := sql.Open("mysql", "bda5522cb9fa9e:d655c1fc@tcp(us-cdbr-iron-east-01.cleardb.net:3306)/ad_4265d05d0278e5f")
    // db, err := sql.Open("mysql", "root:@tcp(192.168.0.6)/go_sample")
